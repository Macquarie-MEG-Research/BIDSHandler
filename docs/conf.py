...
htmlhelp_basename = 'BIDSHandlerdoc'
...
latex_documents = [
    (master_doc, 'BIDSHandler.tex', 'BIDSHandler Documentation',
     'Matt Sanderson', 'manual'),
]
...
man_pages = [
    (master_doc, 'bidshandler', 'BIDSHandler Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BIDSHandler', 'BIDSHandler Documentation',
     author, 'BIDSHandler', 'One line description of project.',
     'Miscellaneous'),
]
